defmodule PokerTest do
  ...
  describe "Poker" do
    ...
    test "check game results" do
      ...
      winner = Score.who_is_winner?(hand1, hand2)
      assert Poker.get_map_of_game_results(winner, hand1, hand2) == 
      %{
        :hand1 => hand1,
        :hand2 => hand2,
        :winner => :hand1,
  ...
  # NOTE: To test the sorting algorithms, uncomment and comment in Score module at # CHANGEME 
  describe "Sort" do
  ...
  describe "Score" do
    ...
    test "Both cards have the same value cards, results in tie" do
      ...
      d5 = {14, :heart}
      hand2 = [d1, d2, d3, d4, d5]
      assert  Score.who_is_winner?(hand1, hand2) == {{:tie, "-"}, {:highcard, 14}}
    end
